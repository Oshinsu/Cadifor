# LEONID DE STROMGARDE
## Le roi dont la mort arrete la guerre
...
| Champ | Valeur |
|-------|--------|
| **Titre** | Roi de Stromgarde |
| **Mort** | 12 mai 846 |
| **Age au deces** | 34 ans |
| **Cause** | Grave maladie |
| **Consequence** | « Notre adversaire n'est plus. La guerre s'arrête. » |
| **Source** | Screen CK2 lot 3 (`c7099a40`) |
...
- `lore/factions/personnages_secondaires.md`
- `lore/meta/screenshots_lot_3_releve.md`
- `lore/CHRONOLOGIE.md`
