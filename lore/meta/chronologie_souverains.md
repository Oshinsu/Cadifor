# CHRONOLOGIE RECTIFIEE DES SOUVERAINS CADIFOR

## Version CK2-compatible stricte
...
| Champ | Valeur | Certitude |
|-------|--------|-----------|
| **Naissance** | `~793/794` | moyenne |
| **Accession** | `825.3.26` | forte |
| **Age a l'accession** | `~31 ans` | moyenne |
| **Mort** | `859.2.17` | forte |
| **Age a la mort** | `~65 ans` | forte |
| **Duree de regne** | `33 ans, 10 mois, 22 jours` | forte |
| **Rang magique** | Mage IX | forte |
| **Parente** | Petit-fils d'Andrea III | forte |

Note : le PDF zone 17600-26400 precise que Banni est **petit-fils** d'Andrea III (pas fils). La generation intermediaire est silencieuse dans les sources.

### 9. Benjamin le Cruel

| Champ | Valeur | Certitude |
|-------|--------|-----------|
| **Naissance** | `~843/844` | moyenne |
| **Accession** | `859.2.17` (mort de Banni) | forte |
| **Mort** | `909.6.20` | forte |
| **Age a la mort** | `~65 ans` | forte |
| **Duree de regne** | `50 ans, 4 mois, 3 jours` | forte |
| **Rang magique** | Mage X | forte |
| **Parente** | Petit-fils de Banni (pas fils) | forte |

Correction : le PDF zone 17600-26400 precise que Benjamin est **petit-fils** de Banni, pas fils. La succession a donc saute une generation. Un cousin mage legendaire a regne entre Banni et Benjamin dans certaines versions du dossier.

### 10. Marjory la Sage

| Champ | Valeur | Certitude |
|-------|--------|-----------|
| **Naissance** | `~873/874` | faible |
| **Accession** | `909.6.20` (mort de Benjamin) | forte |
| **Mort** | `943.9.14` | forte |
| **Age a la mort** | `69 ans` | forte |
| **Duree de regne** | `34 ans, 2 mois, 25 jours` | forte |
| **Rang magique** | Mage X | forte |
| **Parente** | Petite-fille de Banni (cousine de Benjamin) | forte |

### 11. Rose

| Champ | Valeur | Certitude |
|-------|--------|-----------|
| **Naissance** | `~906` | moyenne |
| **Accession** | `943.9.14` (mort de Marjory) | forte |
